...
__attributes = {
    ...
    'CustomSparseStructureLatent': 'sparse_structure_latent',
    'SlatConditionedSparseStructureLatent': 'sparse_structure_latent',
    'SlatTextConditionedSparseStructureLatent': 'sparse_structure_latent',
    'InterpSparseStructureLatent': 'sparse_structure_latent',
    
    'SLat': 'structured_latent',
    'TextConditionedSLat': 'structured_latent',
    'ImageConditionedSLat': 'structured_latent',
    'CustomSLat': 'structured_latent',
    'SlatConditionedSLat': 'structured_latent',
    'SlatTextConditionedSLat': 'structured_latent',
}
...
if __name__ == '__main__':
    ...
    from .sparse_structure_latent import (
        ...
        SlatConditionedSparseStructureLatent,
        SlatTextConditionedSparseStructureLatent,
        InterpSparseStructureLatent,
    )
