...
__attributes = {
    ...
    'SlatConditionedFlowMatchingCFGTrainer': 'flow_matching.flow_matching',
    'SlatTextConditionedFlowMatchingCFGTrainer': 'flow_matching.flow_matching',
    'FlowMatchingDiffusionForcingTrainer': 'flow_matching.flow_matching',
    ...
    'SlatTextConditionedSparseFlowMatchingCFGTrainer': 'flow_matching.sparse_flow_matching',
}
...
if __name__ == '__main__':
    ...
    from .flow_matching.flow_matching import (
        ...
        SlatConditionedFlowMatchingCFGTrainer,
        SlatTextConditionedFlowMatchingCFGTrainer,
        FlowMatchingDiffusionForcingTrainer,
    )
    ...
    from .flow_matching.sparse_flow_matching import (
        ...
        SlatConditionedSparseFlowMatchingCFGTrainer,
        SlatTextConditionedSparseFlowMatchingCFGTrainer,
    )
